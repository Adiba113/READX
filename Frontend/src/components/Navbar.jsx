...
function Navbar() {
  ...
  <label className="px-3 py-1 border-md flex items-center gap-2">
  ...
  <div className="navbar-end">
    <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cousor-pointer">Login</a>
    </div>
  </div>
</div>
    </div>
