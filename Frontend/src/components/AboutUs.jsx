...
import srabani from "../../public/srabani.jpg";
      ...
      <div className="bg-pink-100 p-10 rounded-xl shadow-lg max-w-4xl mx-auto mt-20">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1 text-center">
            ...
            {showMoreSrabani && (
              <p className="mt-4 text-gray-700">
                Srabani Mitra's thought behind making this website is to create a platform that
                empowers readers with easy access to information and a community to share their
                love for reading.
              </p>
            )}
          </div>
          ...
          <div className="flex-1 text-center">
            ...
            {showMoreNusrat && (
              <p className="mt-4 text-gray-700">
                Nusrat Jahan Adiba's vision for this website is to build a resourceful and engaging
                space for book lovers, promoting literacy and the joy of reading.
              </p>
            )}
          </div>
        </div>
